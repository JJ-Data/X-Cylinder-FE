        ...
        <AdaptiveCard className="hover:shadow-lg transition-shadow duration-200">
            <div className="p-4">
                ...
                <Button
                    ...
                    className="w-full"
                    icon={<PiEyeDuotone />}
                    onClick={() => router.push(`/staff/refills/${refill.id}/receipt`)}
                >
                    View Receipt
                </Button>
            </div>
...
export default function StaffRefillsPage() {
    const router = useRouter()
                ...
                return refill?.id ? (
                    <div className="flex items-center justify-end gap-2">
                        <Button
                            ...
                            icon={<PiNoteDuotone />}
                            onClick={() =>
                                router.push(`/staff/refills/${refill.id}/receipt`)
                            }
                        />
                        <Dropdown
                            renderTitle={
                    ...
                    {!isMobile && (
                        <div className="flex gap-2">
                            <Button
                                ...
                                size="md"
                                icon={<PiPlusDuotone />}
                                onClick={() => router.push('/staff/refills/new')}
                            >
                                Record Refill
                            </Button>
                        </div>
