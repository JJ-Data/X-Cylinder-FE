...
export const metadata: Metadata = {
  title: 'New Cylinder Swap | CylinderX Operator',
  description: 'Process a new cylinder swap for customer in your outlet',
}
    ...
    <div className="container mx-auto px-4 py-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Process a cylinder swap for a customer with an active lease in your outlet
        </p>
      </div>
