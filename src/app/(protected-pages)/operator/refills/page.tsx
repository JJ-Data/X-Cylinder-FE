        ...
        <AdaptiveCard className="hover:shadow-lg transition-shadow duration-200">
            <div className="p-4">
                ...
                <Button
                    ...
                    className="w-full"
                    icon={<PiEyeDuotone />}
                    onClick={() => router.push(`/operator/refills/${refill.id}/receipt`)}
                >
                    View Receipt
                </Button>
            </div>
...
export default function OperatorRefillsPage() {
    const router = useRouter()
                ...
                return refill?.id ? (
                    <div className="flex items-center justify-end gap-2">
                        <Button
                            ...
                            icon={<PiNoteDuotone />}
                            onClick={() =>
                                router.push(`/operator/refills/${refill.id}/receipt`)
                            }
                        />
                        <Dropdown
                            renderTitle={
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-sm text-gray-500">
                            Track and manage cylinder refills for your outlet
                        </p>
                    </div>
                    {!isMobile && (
                        <div className="flex gap-2">
                            <Button
                                ...
                                size="md"
                                icon={<PiPlusDuotone />}
                                onClick={() => router.push('/operator/refills/new')}
                            >
                                Record Refill
                            </Button>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div className="md:col-span-2 lg:col-span-2">
                                <Input
                                    ...
                                    placeholder="Search by cylinder code, operator..."
                                    value={searchTerm}
