                                        ...
                                        >
                                            <div key={subNav.key}>
                                                <MenuLink
                                                    ...
                                                    icon={
                                                        (subNav.icon && navigationIcon[
                                                            subNav.icon as keyof typeof navigationIcon
                                                        ]) || <TbCircle />
                                                    }
                                                    title={t(
                                                        subNav.translateKey,
                            ...
                            return (
                                ...
                                >
                                    <MenuLink
                                        ...
                                        icon={
                                            (nav.icon && navigationIcon[nav.icon as keyof typeof navigationIcon]) || (
                                                <TbCircle />
                                            )
                                        }
                            ...
                            {nav.type === NAV_ITEM_TYPE_ITEM && (
                                <Dropdown.Item active={routeKey === nav.key}>
                                    <HorizontalMenuNavLink
                                        ...
                                        onClick={onDropdownClose}
                                    >
                                        <MenuIcon icon={typeof nav.icon === 'string' ? nav.icon : undefined} />
                                        <span>
                                            {t(nav.translateKey, nav.title)}
                                        </span>
                                    </HorizontalMenuNavLink>
                                        ...
                                        >
                                            <div>
                                                <Avatar
                                                    ...
                                                    size={40}
                                                    icon={
                                                        (typeof nav.icon === 'string' && navigationIcon[
                                                            nav.icon as keyof typeof navigationIcon
                                                        ]) || <TbCircle />
                                                    }
                                                    shape="round"
                                                />
                            ...
                            ?.subMenu.map((nav) => (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <span className="text-xl">
                                                {(typeof nav.icon === 'string' && navigationIcon[nav.icon as keyof typeof navigationIcon]) || (
                                                    <TbCircle />
                                                )}
                                            </span>
                                            <span>
