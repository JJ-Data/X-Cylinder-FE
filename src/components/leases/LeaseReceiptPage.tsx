  ...
  return (
    <div className="receipt-container">
      ...
      <div className="receipt-paper">
        <Card className="receipt-card print:shadow-none">
          <div className="receipt-content p-8">
            ...
            <div className="mb-8">
              ...
              <div className="border-t border-gray-200 pt-4">
                <h5 className="font-semibold mb-3">Payment Breakdown</h5>
                
                {/* Show lease amount if available */}
                {leaseData.leaseAmount && parseFloat(leaseData.leaseAmount) > 0 && (
                  <div className="space-y-2 mb-3">
                    <div className="flex justify-between items-center text-sm">
                      <span>Lease Fee:</span>
                      <span className="font-medium">
                        {formatCurrency(parseFloat(leaseData.leaseAmount))}
                      </span>
                    </div>
                  </div>
                )}
                  ...
                  <div className="border-t mt-2 pt-2">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-xl font-bold text-green-600">
                        {formatCurrency(
                          parseFloat(leaseData.leaseAmount) + parseFloat(leaseData.depositAmount)
                        )}
                      </span>
                    </div>
                  </div>
                ...
                <p className="text-xs text-gray-600 mt-3">
                  {leaseData.leaseAmount && parseFloat(leaseData.leaseAmount) > 0 
                    ? 'The lease fee covers the rental period. '
                    : ''}
                  The security deposit will be refunded upon return of the cylinder in good condition.
                </p>
              </div>
            </div>
