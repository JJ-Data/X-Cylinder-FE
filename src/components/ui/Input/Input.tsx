...
const Input = (props: InputProps) => {
    ...
    // Use layout effect to measure sizes after DOM updates
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        const currentPrefixNode = prefixNode.current
        const currentSuffixNode = suffixNode.current

        if (currentPrefixNode) {
            resizeObserver.observe(currentPrefixNode)
        }
        if (currentSuffixNode) {
            resizeObserver.observe(currentSuffixNode)
        }
